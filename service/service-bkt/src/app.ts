/**
 * Express app factory for svc-bkt.
 *
 * Separating the app factory from the HTTP listener allows:
...
import bktRoutes from './routes/index.js';
...
export function createApp(options: CreateAppOptions = {}): Express {
  ...
  // Domain routes — mounted at `/api/bkt` (gateway strips the prefix).
